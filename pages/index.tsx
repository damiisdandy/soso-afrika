      ...
      <main className="text-white ">
        <section>
          ...
          <div className="relative z-20 flex flex-col md:flex-row h-screen">
            <aside className="md:w-[4rem] flex md:flex-col justify-center gap-10 mt-[7rem] md:mt-0 md:gap-8 md:justify-end mx-10 mb-12 md:text-2xl">
            ...
            <div className="md:border-l border-[#888] dark:border-[#444] mt-4 h-full md:overflow-x-hidden flex flex-col justify-end">
              ...
              <p className="mt-8 leading-10 text-md md:text-xl w-[100%] lg:w-[75%] px-[2rem] sm:px-[3rem] text-center md:text-left">
